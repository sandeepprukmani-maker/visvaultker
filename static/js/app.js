...
function displayCoverageAnalysis(coverage, acs) {
    ...
    let html = `
        ...
        <div class="coverage-stats mb-4">
            <div class="stat-item">
                <div class="stat-number text-warning">${updatedCount}</div>
                <div class="stat-label">Updates</div>
            </div>
            <div class="stat-item">
                <div class="stat-number text-success">${newCount}</div>
                <div class="stat-label">New</div>
            </div>
            <div class="stat-item">
                <div class="stat-number text-danger">${redundantCount}</div>
