...
def replace_credential_placeholders(instruction: str) -> tuple[str, list[str]]:
    ...
    for credential in all_credentials:
        ...
        # Look for patterns like "log in to gmail", "login to gmail", "open gmail", "go to gmail"
        login_patterns = [
        ...
        # Navigation patterns - for opening/visiting credentials
        navigation_patterns = [
            f"open {credential_name_lower}",
            f"go to {credential_name_lower}",
            f"visit {credential_name_lower}",
            f"navigate to {credential_name_lower}",
            f"access {credential_name_lower}",
        ]
        
        # Combine all patterns
        all_patterns = login_patterns + navigation_patterns
        
        # Check if any pattern is mentioned
        if any(pattern in instruction_lower for pattern in all_patterns):
            try:
                ...
                if replacement_parts:
                    ...
                    # Find and replace the pattern in the instruction
                    for pattern in all_patterns:
                        if pattern in instruction_lower:
                            ...
                            # Update instruction_lower to reflect the change
                            instruction_lower = processed_instruction.lower()
                            break
