...
def create_app():
    ...
    # Validate encryption key for credential vault
    encryption_key = os.environ.get("ENCRYPTION_KEY")
    if not encryption_key:
        logger.warning("⚠️  ENCRYPTION_KEY not set! Credential vault will not be available.")
        logger.warning("⚠️  Set ENCRYPTION_KEY environment variable to enable secure credential storage.")
