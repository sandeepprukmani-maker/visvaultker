                        ...
                        try:
                            ...
                            try:
                                ...
                                if snapshot_result and isinstance(snapshot_result, dict):
                                    ...
                                    if screenshot_path and progress_callback:
                                        self.logger.info(f"📸 Step {len(steps)} screenshot captured: {screenshot_path}")
                                ...
                                self.logger.warning(f"⚠️  Step {len(steps)} screenshot capture failed: {screenshot_error}")
