...
class EngineOrchestrator:
    ...
    def execute_instruction(self, instruction: str, engine_type: str, headless: bool, progress_callback=None) -> Dict[str, Any]:
        ...
        if engine_type == 'browser_use':
            ...
            return self._execute_playwright_mcp(instruction, progress_callback)
    ...
    def _execute_playwright_mcp(self, instruction: str, progress_callback=None) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                result = loop.run_until_complete(engine.run_task(instruction))
            finally:
                loop.close()
