                ...
                while (true) {
                    ...
                    for (const line of lines) {
                        ...
                        try {
                            ...
                            } else if (data.type === 'credential_injection') {
                                // Display credential injection notification
                                stepLogs.push(`<div style="color: var(--success-text); margin: 3px 0;">🔐 ${data.data.message}</div>`);
                                document.getElementById('execution-logs').innerHTML = stepLogs.join('');
