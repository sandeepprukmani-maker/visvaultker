...
The application requires API keys for AI model providers. These are loaded from a `.env` file:
...
See `.env.example` for the complete template and `SETUP.md` for detailed setup instructions.
