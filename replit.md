...
- **Site Crawler & Knowledge Base** (NEW): Intelligent website crawler that learns site structure, elements, and interactions using browser-use AI. The crawler:
  - Discovers and maps all pages within a site
  - Identifies interactive elements, forms, and navigation patterns
  - Compiles knowledge about the site's structure and behavior
  - Automatically enhances automation tasks with learned knowledge
  - Supports password-protected sites via credential vault integration
