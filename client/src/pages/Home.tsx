  ...
  return (
    <div className="flex h-full flex-col bg-background">
      <main className="flex flex-1 flex-col items-center justify-start p-6">
        ...
        {/* Generated Rerunnable Script Section */}
        {generatedCode.locators && status === "completed" && (
          <div className="mt-6 w-full max-w-6xl">
            <div className="bg-card border rounded-md p-4">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-lg font-semibold">Generated Rerunnable Script</h3>
                <button
                  onClick={() => {
              ...
              <p className="text-sm text-muted-foreground mb-3">
                This code uses locators and deepLocators for rerunnable automation without LLM calls.
              </p>
              <pre className="bg-muted p-4 rounded-md overflow-x-auto text-sm font-mono max-h-96 overflow-y-auto">
                <code data-testid="text-generated-script">{generatedCode.locators}</code>
              </pre>
            </div>
          </div>
        )}
