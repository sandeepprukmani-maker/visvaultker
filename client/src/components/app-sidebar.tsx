import { Bot, Home, BookOpen, GitBranch, Play, Settings, Sparkles } from "lucide-react";
    ...
    <Sidebar>
      <SidebarHeader className="p-6">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-lg font-semibold">AutomateAI</h1>
      ...
      <SidebarFooter className="p-4">
        <div className="rounded-lg bg-muted p-3">
          ...
          <p className="text-xs text-muted-foreground">Unlimited automations</p>
        </div>
      </SidebarFooter>
    </Sidebar>
  );
