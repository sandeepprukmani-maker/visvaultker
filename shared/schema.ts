...
export const unifiedAutomationRequestSchema = z.object({
  ...
  authMode: z.enum(["standard", "oauth"]).default("standard"),
});
...
// Performance metrics schema (Stagehand v3 feature)
...
export const automationResponseSchema = z.object({
  ...
  generatedCode: z.object({
    ...
    optimized: z.string().optional(), // Optimized observe+act pattern (2-3x faster)
  }),
  ...
  metrics: performanceMetricsSchema.optional(), // Performance metrics (tokens, time)
});
